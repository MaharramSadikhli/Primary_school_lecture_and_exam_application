...
const hesaplamaP1 = document.getElementsByClassName("hesaplamaP1");
const hesaplamaP2 = document.getElementsByClassName("hesaplamaP2");
...
function soruGetir() {
  ...
  if (sunucudanGelen.sorular[sira].type === "secenekli") {
    ...
    $("#formbosluk").css("display", "none");
    $("#formhesaplama").show();
    hesaplamaP1.innerText = siradakiSoruIcerigi.hesaplamaP1;
    hesaplamaP2.innerText = siradakiSoruIcerigi.hesaplamaP2;
  }
}
